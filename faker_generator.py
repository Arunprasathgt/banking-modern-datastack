...
def run_iteration():
    ...
    for customer_id in customers:
        for _ in range(ACCOUNTS_PER_CUSTOMER):
            ...
            cur.execute(
                "INSERT INTO accounts (customer_id, account_type, balance,currency) VALUES (%s, %s, %s, %s) RETURNING acc_id",
    ...
    for _ in range(NUM_TRANSACTIONS):
        ...
        cur.execute(
            "INSERT INTO transactions (acc_id, txn_type, amount, related_acc_id, status) VALUES (%s, %s, %s, %s, 'COMPLETED')",
